                ...
                <div class="w-full flex h-[30rem]">
                    <div class="justify-self-start w-full bg-[#f0faff] px-5 rounded-bl-lg overflow-auto max-h-106">
                        <div class="mt-3 w-full flex">
                            <form class="w-2/5" method='post' action='cancelledItems.php'>
                            ...
                            <div class="w-1/5">
                                <a href="cancelledItems.php"><button class="w-24 ml-2 rounded-lg bg-[#67b0e7] text-white hover:bg-[#2986CC] p-2 text-sm">All</button></a>
                            </div>
                            <div class="w-1/5">
                                <a href="cancelledItemsPrint.php"><button class=" w-full rounded-lg bg-[#67b0e7] text-white hover:bg-[#2986CC] p-2 text-sm">Print</button></a>
                            </div>
                        </div>   
