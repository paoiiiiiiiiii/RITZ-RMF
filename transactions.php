                    ...
                    <div class="justify-self-start w-full bg-[#f0faff] px-5 rounded-bl-lg overflow-auto max-h-106">
                        <div class="mt-3 w-full flex">
                            ...
                            <form method="post" action="transactions.php" class="w-1/5">
                                <input type="text" name="searchTag" placeholder="Search Invoice" class="w-32 outline outline-offset-2 outline-[#2986CC] rounded-md text-sm bg-transparent text-md text-[#2986CC] ml-2 p-1" required></input>
